...
class BbcWebProxyFeature extends BbcWebBaseFeature
{
    ...
    public function init(BbcWebContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BbcWebContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
