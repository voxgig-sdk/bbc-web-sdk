...
class BbcWebTimeoutFeature extends BbcWebBaseFeature
{
    ...
    private function _with_timeout(BbcWebContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BbcWebContext $_ctx, float $ms): void
    {
        $client = $this->client;
