...
class BbcWebFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BbcWebSDK/1.0)';
    ...
    public static function call(BbcWebContext $ctx, string $fullurl, array $fetchdef): array
    {
