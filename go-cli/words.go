...
func registerSDKWords(r *eng.Registry, client *sdk.BbcWebSDK) {
...
func runOp(client *sdk.BbcWebSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
