...
func registerTools(server *mcp.Server, client *sdk.BbcWebSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bbc-web_list",
		Description: "List records from BbcWeb. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bbc-web_load",
		Description: "Load a single record from BbcWeb. " +
...
func runOp(client *sdk.BbcWebSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BbcWebSDK, name string) (sdk.BbcWebEntity, error) {
