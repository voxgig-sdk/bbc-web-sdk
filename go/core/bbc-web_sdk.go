...
func (sdk *BbcWebSDK) OptionsMap() map[string]any {
...
func (sdk *BbcWebSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BbcWebSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BbcWebSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BbcWebSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BbcWebSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BbcWebSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BbcWebSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BbcWebSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BbcWebSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BbcWebSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *BbcWebSDK) Content(data map[string]any) BbcWebEntity {
