...
BbcWebSDK._make_feature = _make_feature


function BbcWebSDK.new(options)
  local self = setmetatable({}, BbcWebSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BbcWebSDK:options_map()
...
function BbcWebSDK:get_utility()
  return Utility.copy(self._utility)
end


function BbcWebSDK:get_root_ctx()
  return self._rootctx
end


function BbcWebSDK:prepare(fetchargs)
...
function BbcWebSDK:direct(fetchargs)
...
-- by passing it.
function BbcWebSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BbcWebSDK:graphql(query, variables, ctrl)
...
function BbcWebSDK:Content(data)
...
function BbcWebSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BbcWebSDK.new(sdkopts)
  sdk.mode = "test"
