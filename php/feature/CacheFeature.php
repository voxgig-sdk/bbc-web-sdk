...
class BbcWebCacheFeature extends BbcWebBaseFeature
{
    ...
    private function _through(BbcWebContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
