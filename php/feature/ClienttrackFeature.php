...
// BbcWeb SDK clienttrack feature
...
class BbcWebClienttrackFeature extends BbcWebBaseFeature
{
    ...
    public function PostConstruct(BbcWebContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BbcWeb-SDK';
