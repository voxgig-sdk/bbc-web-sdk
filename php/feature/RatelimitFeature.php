...
class BbcWebRatelimitFeature extends BbcWebBaseFeature
{
    ...
    private function _acquire(BbcWebContext $ctx): void
    {
    ...
    private function _track(BbcWebContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
