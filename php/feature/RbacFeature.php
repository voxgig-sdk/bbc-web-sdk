...
class BbcWebRbacFeature extends BbcWebBaseFeature
{
    ...
    private function _required(BbcWebContext $ctx): ?string
    {
    ...
    private function _reject(BbcWebContext $ctx, string $required): void
    {
    ...
    private function _track(BbcWebContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
