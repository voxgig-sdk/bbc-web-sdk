...
class BbcWebStreamingFeature extends BbcWebBaseFeature
{
    ...
    private function _iterate(BbcWebResult $result): \Generator
    {
    ...
    private function _streamable(BbcWebContext $ctx): bool
    {
