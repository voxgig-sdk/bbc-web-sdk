...
// BbcWeb SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BbcWebTestFeature extends BbcWebBaseFeature
{
    ...
    public function init(BbcWebContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BbcWebContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BbcWebContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BbcWebContext $ctx, $op, $args): array
    {
