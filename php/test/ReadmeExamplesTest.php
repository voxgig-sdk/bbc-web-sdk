...
// BbcWeb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BbcWebSDK::test)
...
{
    private const SDK_CLASS = 'BbcWebSDK';
    ...
    private const SDK_BASE = 'bbcweb_sdk';
