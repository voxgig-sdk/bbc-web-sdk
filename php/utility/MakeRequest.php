...
// BbcWeb SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BbcWebMakeRequest
{
    public static function call(BbcWebContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BbcWebResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BbcWebResponse($fetched);
        } else {
