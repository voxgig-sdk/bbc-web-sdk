...
The Python SDK for the BbcWeb API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/bbc-web-sdk/releases)) or
