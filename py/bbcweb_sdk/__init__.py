...
from bbcweb_sdk.utility import register

# Load features
from bbcweb_sdk.feature.base_feature import BbcWebBaseFeature
from bbcweb_sdk.features import _make_feature
...
class BbcWebSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BbcWebUtility()
        self._utility = utility

        from bbcweb_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return BbcWebUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BbcWebSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Content(self, data=None) -> "ContentEntity":
        ...
        from bbcweb_sdk.entity.content_entity import ContentEntity
        return ContentEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BbcWebSDK":
        if sdkopts is None:
            sdkopts = {}
