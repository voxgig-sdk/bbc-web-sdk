...
from bbcweb_sdk.core.control import BbcWebControl
...
from bbcweb_sdk.core.helpers import get_ctx_prop, to_map
...
class BbcWebContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, BbcWebResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BbcWebError(code, msg, self)
