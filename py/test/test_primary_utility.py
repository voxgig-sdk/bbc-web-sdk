...
from bbcweb_sdk.core.spec import BbcWebSpec
from bbcweb_sdk.core.result import BbcWebResult
from bbcweb_sdk.core.response import BbcWebResponse
from bbcweb_sdk.core.operation import BbcWebOperation
from bbcweb_sdk.core.error import BbcWebError
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BbcWebSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = BbcWebSDK.test(None, None)
        ...
        class TestInitFeature(BbcWebBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BbcWebBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BbcWebSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BbcWebSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BbcWebSDK.test(None, setup_opts)
