# BbcWeb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BbcWebSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BbcWebSDK(...) and BbcWebSDK.test(...) become
#      BbcWebSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bbcweb_sdk"
_SDK_CLASS = "BbcWebSDK"
